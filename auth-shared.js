...
/* harmony export */   d: () => (/* binding */ Amplify)
/* harmony export */ });
...
var logger = new _Logger__WEBPACK_IMPORTED_MODULE_0__/* .ConsoleLogger */ .k('Amplify');
var AmplifyClass = /** @class */ (function () {
    function AmplifyClass() {
        ...
        this.Logger = _Logger__WEBPACK_IMPORTED_MODULE_0__/* .ConsoleLogger */ .k;
...
var logger = new _Logger__WEBPACK_IMPORTED_MODULE_0__/* .ConsoleLogger */ .k('Hub');
...
__webpack_require__.d(__webpack_exports__, {
  k: () => (/* binding */ ConsoleLogger)
});

// UNUSED EXPORTS: LOG_TYPE
...
var BehaviorSubject = /*#__PURE__*/function () {
  function BehaviorSubject(initialValue) {
    (0,_babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)(this, BehaviorSubject);
    this.value = initialValue;
    this.subscribers = [];
  }
  (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z)(BehaviorSubject, [{
    key: "subscribe",
    value: function subscribe(subscriber) {
      var _this = this;
      this.subscribers.push(subscriber);
      subscriber(this.value); // emit current value to new subscriber
      return function () {
        // unsubscribe
...
;// CONCATENATED MODULE: ./src/shared/amplify-config.ts

Amplify/* Amplify */.d.configure(window.cognitoConfiguration);
// EXTERNAL MODULE: ./node_modules/@aws-amplify/core/lib-esm/Hub.js
var Hub = __webpack_require__(490);
// EXTERNAL MODULE: ./src/shared/auth-helper.ts
var auth_helper = __webpack_require__(3756);
;// CONCATENATED MODULE: ./src/shared/menu-items.ts


var topNavLoginSelector = '.top-nav-v2__login';
var topNavAccountSelector = '.top-nav-v2__account';
var visibilityClass = 'visible';
var hideLoginButton = function hideLoginButton() {
  var loginButtons = document.querySelectorAll(topNavLoginSelector);
  var accountButtons = document.querySelectorAll(topNavAccountSelector);
  loginButtons.forEach(function (button) {
    return button.classList.remove(visibilityClass);
  });
  accountButtons.forEach(function (button) {
    return button.classList.add(visibilityClass);
  });
};
var hideAccountButton = function hideAccountButton() {
  var loginButtons = document.querySelectorAll(topNavLoginSelector);
  var accountButtons = document.querySelectorAll(topNavAccountSelector);
  loginButtons.forEach(function (button) {
    return button.classList.add(visibilityClass);
...
var windowAuthCallback = function windowAuthCallback() {
  if ((0,auth_helper/* getIsAuthenticated */.j3)()) {
    hideLoginButton();
  } else {
    hideAccountButton();
  }
...
var checkIsSignedIn = function checkIsSignedIn() {
  ...
  Hub/* Hub */.X.listen('auth', listener);
  window.addEventListener('storage', windowAuthCallback);
  document.removeEventListener('readystatechange', checkIsSignedIn);
};
document.addEventListener('readystatechange', checkIsSignedIn);
// EXTERNAL MODULE: ./src/shared/auth-analytics.ts
var auth_analytics = __webpack_require__(880);
// EXTERNAL MODULE: ./src/shared/smartbannerStatus.ts
var smartbannerStatus = __webpack_require__(1890);
;// CONCATENATED MODULE: ./src/shared/app.ts
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   W0: () => (/* binding */ userErrorData),
/* harmony export */   XG: () => (/* binding */ pushAnalytics)
/* harmony export */ });
/* unused harmony export initAuthAnalytics */
/* harmony import */ var _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4942);
/* harmony import */ var _auth_helper__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3756);
...
var excludedAttributes = ['email', 'family_name', 'given_name'];
var getAccountDetails = function getAccountDetails(userData) {
  return userData.UserAttributes.reduce(function (acc, attribute) {
...
var getUserAuthData = function getUserAuthData(isAuthenticated, userData) {
  if (!isAuthenticated) {
    return baseDataObject;
  }
  return _objectSpread(_objectSpread({}, baseDataObject), {}, {
    authenticated: true,
    accountId: userData.Username,
    accountDetails: getAccountDetails(userData)
  });
};
var initAuthAnalytics = function initAuthAnalytics() {
  var isAuthenticated = (0,_auth_helper__WEBPACK_IMPORTED_MODULE_1__/* .getIsAuthenticated */ .j3)();
  var userData = (0,_auth_helper__WEBPACK_IMPORTED_MODULE_1__/* .getUserData */ .is)();
  if (isAuthenticated && !userData) return;
  var data = getUserAuthData(isAuthenticated, userData);
  pushAnalytics(data);
};
var pushAnalytics = function pushAnalytics(data) {
  if (window.dataLayer && typeof window.dataLayer.push === 'function') {
    window.dataLayer.push(data);
  }
};
document.addEventListener('DOMContentLoaded', initAuthAnalytics);
...
/* harmony export */   j3: () => (/* binding */ getIsAuthenticated)
/* harmony export */ });
/* unused harmony export getUserDataKey */
var pattern = /CognitoIdentityServiceProvider(.*)\.userData/g;
var getIsAuthenticated = function getIsAuthenticated() {
  return Object.keys(localStorage).some(function (key) {
    return key.match(pattern);
  });
};
var getUserDataKey = function getUserDataKey() {
...
var getUserData = function getUserData() {
  ...
  var data = localStorage.getItem(userDataKey || '');
  if (!data) {
    return null;
  }
  try {
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   U: () => (/* binding */ smartbannerStatus)
/* harmony export */ });
/* harmony import */ var _BehaviorSubject__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8932);


// Default to true for mobile devices because the smartbanner is initialized with a delay. On desktop, we simulate the smartbanner being closed by default.
var smartbannerStatus = new _BehaviorSubject__WEBPACK_IMPORTED_MODULE_0__/* .BehaviorSubject */ .X(window.innerWidth <= 768);
var SMARTBANNER_VIEW = 'smartbanner.view';
var SMARTBANNER_CLICKOUT = 'smartbanner.clickout';
var SMARTBANNER_EXIT = 'smartbanner.exit';
var handleOpened = function handleOpened() {
  smartbannerStatus.next(true);
};
var handleClosed = function handleClosed() {
  smartbannerStatus.next(false);
};
document.addEventListener(SMARTBANNER_VIEW, handleOpened);
document.addEventListener(SMARTBANNER_CLICKOUT, handleClosed);
document.addEventListener(SMARTBANNER_EXIT, handleClosed);

// Cleanup: remove event listeners on page unload
var handleBeforeUnload = function handleBeforeUnload() {
  document.removeEventListener(SMARTBANNER_VIEW, handleOpened);
  document.removeEventListener(SMARTBANNER_CLICKOUT, handleClosed);
  document.removeEventListener(SMARTBANNER_EXIT, handleClosed);
};
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("ef3794804376116ba670")
/******/ 	})();
/******/ 	
...
/******/ 		}
/******/ 		
/******/ 		self["webpackHotUpdateauth"] = (chunkId, moreModules, runtime) => {
...
/******/ 	var __webpack_exports__ = __webpack_require__(4576);
/******/ 	__webpack_exports__ = __webpack_require__.O(__webpack_exports__);
/******/ 	
/******/ })()
;
//# sourceMappingURL=shared.db60aa5b775aab8569ca.js.map